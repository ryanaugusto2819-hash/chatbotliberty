...
CREATE INDEX IF NOT EXISTS idx_messages_conv_sender_status ON messages(conversation_id, sender_type, status);
CREATE INDEX IF NOT EXISTS idx_contact_tags_phone ON contact_tags(contact_phone);
CREATE INDEX IF NOT EXISTS idx_conversations_updated_at ON conversations(updated_at DESC);

-- RPC: Paginated inbox with server-side filters and tags included
